...
\begin{document}
	...
	\begin{frame}{Masking}
		...
		\begin{itemize}
			...
			\item \textbf{Output of XOR gate:} Compute $\hat{z}_\gamma = (z_\alpha \oplus z_\beta) \oplus (\lambda_\alpha \oplus \lambda_\beta) = (z_\alpha \oplus \lambda_\alpha) \oplus (z_\beta \oplus \lambda_\beta) =\hat{z}_\alpha \oplus \hat{z}_\beta$.
